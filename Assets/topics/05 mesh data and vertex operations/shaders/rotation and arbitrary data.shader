    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Interpolators vert (MeshData v)
            {
                ...
                float4x4 x = rotation_matrix(float3(1, 0, 0), _rotX * TAU * v.color.r);
                float4x4 y = rotation_matrix(float3(0, 1, 0), _rotY * TAU * v.color.r);
                float4x4 z = rotation_matrix(float3(0, 0, 1), _rotZ * TAU * v.color.r);
